...
public class CoverageMergeTest extends TestCase
{
	...
	private static final String[] ALL_CLASS_NAMES = new String[]{
			"Test1",
			"Test2",
			COMMON
	};
	private static final String[] FRST_CLASS_NAMES = new String[]{
			"Test1",
			null,
			COMMON
	};
	private static final String[] SCD_CLASS_NAMES = new String[]{
			null,
			"Test2",
			COMMON
	};
	...
	private static String getTestDataPath(String className) throws Exception
	{
		return TestPathUtil.getTestPath() + File.separator + "coverage" + File.separator + "merge" + File.separator + className;
	}
