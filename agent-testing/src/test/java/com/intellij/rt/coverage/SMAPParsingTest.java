...
public class SMAPParsingTest extends TestCase
{
	...
	public void test1()
	{
		final String test = "SMAP\n" + "Hello_jsp.java\n" + "JSP\n" + "*S JSP\n" + "*F\n" + "+ 1 Hello.jsp\n" + "Hello.jsp\n" + "+ 2 greeting.jsp\n" + "greeting.jsp\n" + "*L\n" + "1,5:59\n" + "1#2," +
				"2:64\n" + "3:66,4\n" + "6#1,3:70\n" + "*E";
		final FileMapData[] expected = new FileMapData[]{
				new FileMapData("org.apache.jsp.Hello_jsp", new LineMapData[]{
				...
				new FileMapData("org.apache.jsp.greeting_jsp", new LineMapData[]{
