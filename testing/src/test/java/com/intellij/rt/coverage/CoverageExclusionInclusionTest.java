...
public class CoverageExclusionInclusionTest extends TestCase {
  ...
  private File getTestDataFile() {
    return new File(ResourceUtil.getResourceRoot(CoverageExclusionInclusionTest.class)
                    + File.separator + "testData" + File.separator + "coverage" + File.separator + "exclusionInclusion");
  }
}
