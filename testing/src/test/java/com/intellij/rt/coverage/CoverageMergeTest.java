...
public class CoverageMergeTest extends TestCase {
  ...
  private static String getTestDataPath(String className) {
    return ResourceUtil.getResourceRoot(CoverageMergeTest.class) + File.separator + "testData" + File.separator + "coverage" + File.separator + "merge" + File.separator + className;
  }
